...
var c2: Tournament = Tournament(id: 54321, name: "Torneio dos Guri", tournamentType: .Group, organizerId: 2, players: [], courts: [Court(id: 1, name: "Ipsum", line: [])], startingTime: .now, ranking: [], tournamentMatches: [Node(id: 1, empty: 0, player: "JoeShmoes & MoeShgoe", time: Date.init(), court: Court(id: 1, name: "Ipsum", line: []), winner: 0)], groups: [], location: "Centro Histórico", adress: "Borges de Medeiros 123")
