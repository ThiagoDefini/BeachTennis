...
var c2: Tournament = Tournament(id: 54321, name: "Torneio dos Guri", tournamentType: .Group, organizerId: 2, players: [], courts: [], startingTime: .now, ranking: [], tournamentMatches: [], groups: [], location: "Centro Histórico", adress: "Borges de Medeiros 123")
